    ...
    return (
        <div className='flex ml-3 mb-5'>
            ...
            <div className='ml-3'>
                ...
                <p>{review.review}</p>
                <button onClick={() => onDelete(review._id, review.titleReview)} className='relative mt-3 left-52 border-2 border-teal-500 border-opacity-50 px-3 py-px'> Delete</button>
