...
export default function EditMovie() {
    ...
    return (
        <div>
            {movieToDB && <div>
                <h1 className='text-2xl font-bold ml-10 pt-10'> Edit <span className='text-[#65B3AD]' >movie</span></h1>
                <form onSubmit={handleSubmit} className="flex flex-col searchForm top-48 mx-10">
                    ...
                    <input className='rounded h-11 px-3 w-full text-gray-200 bg-gray-700 text-lg focus:outline-[#65B3AD]' type="text" name="imdb_id" defaultValue={movieToDB.imdb_id?movieToDB.imdb_id:undefined} onChange={handleChange}/>
                    ...
                    <div className="peopleAndRoleForm">
                        <input type="text" name="department1" defaultValue={movieToDB.department1? movieToDB.department1:""} className='rounded h-11 px-3 w-full text-gray-200 bg-gray-700 text-lg focus:outline-[#65B3AD]' onChange={handleChange}/>
                        <input type="text" name="people1" defaultValue={movieToDB.people1? movieToDB.people1:""} className='mt-1 rounded h-11 px-3 w-full text-gray-200 bg-gray-700 text-lg focus:outline-[#65B3AD]' onChange={handleChange}/>
                        <input type="text" name="department2" defaultValue={movieToDB.department2? movieToDB.department2:""} className='mt-5 rounded h-11 px-3 w-full text-gray-200 bg-gray-700 text-lg focus:outline-[#65B3AD]' onChange={handleChange}/>
                        <input type="text" name="people2" defaultValue={movieToDB.people2? movieToDB.people2:""} className='mt-1 rounded h-11 px-3 w-full text-gray-200 bg-gray-700 text-lg focus:outline-[#65B3AD]' onChange={handleChange}/>
                    </div>
