        ...
        <div>
            {movieToDB && <div>
                ...
                <form className="flex flex-col searchForm top-48 mx-10" onSubmit={handleSubmit}>
                    ...
                    <input type="text" name="imdb_id" defaultValue={movieToDB.imdb_id?movieToDB.imdb_id:undefined} className='rounded h-11 px-3 w-full text-gray-200 bg-gray-700 text-lg focus:outline-teal-600' onChange={handleChange}/>
